...
public class Administrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(entrarB, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 320, 60, 40));
        ...
        jPanel1.add(atrasB, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 60, 40));
        ...
        jPanel1.add(contraseñaT, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 110, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Administrador.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 140, 150));
        ...
        jLabel5.setText("ADMINISTRACION DEL PERSONAL");
    ...
    public void ingreso(){
        String usuario = "jose", contra = "123";
        ...
        if(usuarioIngresado.equals(usuario)== false || claveIngresada.equals(contra)== false){
           ...
           this.dispose();
           AdminRegistros admin = new AdminRegistros();
